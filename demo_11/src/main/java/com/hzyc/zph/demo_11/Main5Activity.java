...
public class Main5Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.xinxiye);
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if ("".equals(username) || "".equals(tell)) {
                    Toast.makeText(Main5Activity.this, "无信息保存", Toast.LENGTH_SHORT).show();
                } else {
                    ...
                    Toast.makeText(Main5Activity.this, "保存" + bol, Toast.LENGTH_SHORT).show();


                    DbUtils dbUtils = new DbUtils(Main5Activity.this);
                    SQLiteDatabase sqLiteDatabase=dbUtils.getWritableDatabase();
                    sqLiteDatabase.execSQL("insert into person (name,phone,image) values ('"+name.getText().toString().trim()+"','"+tel.getText().toString().trim()+"','"+imagePath+"')");
